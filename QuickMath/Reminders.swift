...
enum Reminders {
    private static let identifier = "practice.daily.reminder"
    ...
    static func schedule(hour: Int, minute: Int) {
        ...
        content.title = "Your daily wisdom awaits"
        content.body = "Open Practice to see today's principle and complete your micro-action."
